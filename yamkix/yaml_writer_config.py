...
class YamlWriterConfig:
    """Config stanza for YAML parser/writer with opinionated defaults."""
...
def build_yaml_writer_config_from_args(
    ...
    """Build a YamlWriterConfig object from parsed args."""
...
def get_opinionated_yaml_writer(writer_config: YamlWriterConfig,) -> YAML:
